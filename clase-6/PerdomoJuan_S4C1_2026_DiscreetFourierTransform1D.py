...
#Use la gráfica de la transformada de fourier del punto 2 para determinar un valor apropiado de la frecuencia de corte que debe usar para filtrar dicho ruido de alta frecuencia.
...
# Qué hace que siendo la misma nota (misma frecuencia) el tiembre del violin y de la trompeta sean tan diferentes...

print(f"\n Nuestro oido percibe la misma nota de manera diferente porque el timbre de los dos instrumentos es distinto. Esto se debe a que si bien ambos tienen las mismas frecuencias, los armonicos tienen amplitudes distintas, como se observa en las graficas de la transformada de Fourier, y son estas las que distribuyen la energia de los sobretonos. \n")